...
/*:
 * @plugindesc メニューを開く直前、または閉じた直后に、指定したコモンイベントを実行します。
 * @author 奏ねこま（おとぶきねこま）
 *
 ...
 * @desc メニューを閉じた直后に実行するコモンイベントのIDを指定してください。
 * @default 0
 *
 * @help
 ...
 *                             イベント后にメニューが開かない問題を修正
 *   Version 1.02  2017/02/13  メニュー后コモンイベントが、マップ以外への
 *                             シーン遷移時にも実行予約されていた問題を修正
 *   Version 1.01  2017/01/05  メニュー后コモンイベントIDを0に設定しても
